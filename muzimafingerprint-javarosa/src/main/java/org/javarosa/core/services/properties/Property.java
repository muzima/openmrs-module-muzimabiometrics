...
public class Property implements Persistable, IMetaData {
    ...
    /** (non-Javadoc)
     *  @see org.javarosa.core.util.externalizable.singlequestionscreen.storage.Externalizable#readExternal(java.io.DataInputStream)
     */
    ...
    /** (non-Javadoc)
     *  @see org.javarosa.core.util.externalizable.singlequestionscreen.storage.Externalizable#writeExternal(java.io.DataOutputStream)
     */
