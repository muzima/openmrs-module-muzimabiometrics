...
public class Localizer implements Externalizable {
	 ...
	 * @throws org.javarosa.core.util.UnregisteredLocaleException If locale is null or not defined.
	 */
	 ...
	 * @throws org.javarosa.core.util.UnregisteredLocaleException If locale is not defined.
	 */
	 ...
	 * @throws org.javarosa.core.util.UnregisteredLocaleException If locale is not defined or null.
	 */
	 ...
	 * @throws org.javarosa.core.util.UnregisteredLocaleException If current locale is not set.
	 ...
	 * @throws org.javarosa.core.util.UnregisteredLocaleException If current locale is not set.
	 * @throws NullPointerException if textID is null
 	 * @throws org.javarosa.core.util.NoLocalizedTextException If there is no text for the specified id
	 */
	 ...
	 * @param locale Locale. Must be defined and not null.
	 * @return Localized text. If no text is found after using all fallbacks, return null.
	 * @throws org.javarosa.core.util.UnregisteredLocaleException If the locale is not defined or null.
	 * @throws NullPointerException if textID is null
	 */
