        ...
        <form id="formData" method="post" action="" style="border: 1px solid #eeeeee;padding:20px;">
            <fieldset style="width:100%;">
                ...
                <div class="form-group">
                    <label for="given_name">Given</label>
            ...
            <fieldset style="width:100%;">
                ...
                <div class="form-group">
                    <div class="form-inline">
                        <input type="radio" na-me="sex" value="F" class="form-control"><b>Female</b>
                    ...
                    <input autocomplete="off" id="datepicker" name="birthdate" class="form-control" required>
                </div>
            </fieldset>
            <fieldset>
...
<script>
    $(document).ready(function(){
        $("#datepicker1").change(function(){
            var dateb=$("#datepicker1").val();
            var dob = new Date(dateb);
            var today = new Date();
            var age = Math.floor((today-dob) / (365.25 * 24 * 60 * 60 * 1000));
            if(isNaN(age))
            {
                $("#age").val("its not a number");
            }
            else
            {
                $("#age").val(age);
