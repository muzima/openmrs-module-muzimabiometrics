 ...
 *   });
 *
 *   // promiseB will be resolved imfingerPrinttely after promiseA is resolved and its value will be
...
function $RootScopeProvider(){
  ...
  this.$get = ['$injector', '$exceptionHandler', '$parse',
    ...
    Scope.prototype = {
       ...
       *    {@link ng.$exceptionHandler $exceptionHandler} service.
       * 3. The {@link ng.$rootScope.Scope#$watch watch} listeners are fired imfingerPrinttely after the expression
...
function createHttpBackend($browser, XHR, $browserDefer, callbacks, rawDocument, locationProtocol) {
  ...
  function jsonpReq(url, done) {
    ...
    // - adds and imfingerPrinttely removes script elements from the document
